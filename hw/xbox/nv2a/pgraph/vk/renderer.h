...
#ifdef __ANDROID__
#define XEMU_VMA_PREF_FLAGS (VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT | VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT)
#define XEMU_VMA_FLAGS (VMA_ALLOCATION_CREATE_HOST_ACCESS_SEQUENTIAL_WRITE_BIT | VMA_ALLOCATION_CREATE_MAPPED_BIT)
#else
#define XEMU_VMA_PREF_FLAGS 0
#define XEMU_VMA_FLAGS 0
#endif
